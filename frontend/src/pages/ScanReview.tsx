...
export function ScanReview() {
  ...
  const selectFinding = (finding:Finding) => {setActive(finding);if(scan)setFilePath(pathFor(finding,scan));setProposal(undefined);setVerification(undefined);setRationale('');setError('');};
